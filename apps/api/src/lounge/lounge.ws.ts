...
export function broadcastLoungeSettingsUpdate(loungeId: string, settings: LoungeSettings) {
  broadcast(loungeId, { type: 'lounge_settings_updated', data: { settings: settings } })
}
