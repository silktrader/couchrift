...
<div class="flex flex-1 min-h-0 w-full flex-col">
    ...
    <div class="flex flex-col min-h-0 flex-1 my-8 overflow-y-auto gap-6">

        <!-- Shortcode-->
        <div class="flex w-full max-w-lg flex-col items-center gap-4">
            <span class="text-muted-foreground">Shortcode</span>
            <div class="flex flex-row items-center gap-2 bg-card rounded-lg p-4">
                <span class="font-mono text-2xl tracking-widest">{ls.lounge.shortcode}</span>
        ...
        <!-- Controls-->
        {#if isCreator}
            <div class="flex flex-col items-center justify-end gap-6 flex-1 mt-8">
