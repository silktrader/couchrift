                    ...
                    <div class="w-full" animate:flip>
                        <Item.Root variant="outline" class="w-full" onclick={() => handleGotoLounge(lounge)}>
                            ...
                            <Item.Content class="flex items-end">
                                <Item.Title
                                        class="text-md font-mono font-semibold tracking-wider">{lounge.shortcode}</Item.Title>
                                <Item.Description
                                        class="text-sm italic">{formatRelativeTime(lounge.createdAt)}</Item.Description>
                            </Item.Content>
                        </Item.Root>
                    </div>
                {:else}
                    ...
                    <div class="w-full" animate:flip>
                        <Item.Root variant="outline" class="w-full" onclick={() => goto(`/lounges/${lounge.id}`)}>
                            ...
                            <Item.Content class="flex items-end">
                                ...
                                <Item.Description
                                        class="text-sm italic">{formatRelativeTime(lounge.endedAt)}</Item.Description>
                            </Item.Content>
