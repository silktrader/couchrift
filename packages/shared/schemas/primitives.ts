...
// Don't tie shortcodes to configuration values in /shared/config/ids.ts as they are prone to changes
...
export const FriendRequestIdSchema = Type.String({minimum: 0})